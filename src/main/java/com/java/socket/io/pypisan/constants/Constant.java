...
public class Constant {
    ...
    public static final String WELCOME_MESSAGE = "Socket connection has initiated.";
    public static final String DISCONNECT_MESSAGE = "Socket connection has been disconnected.";
